...
const myFavoritePet = "cat"

console.log(myFavoritePet instanceof String)

console.log(typeof myFavoritePet)

const petToUpperCase = myFavoritePet.toUpperCase()

console.log(petToUpperCase)